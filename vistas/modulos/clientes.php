      ...
      <div class="modal-body bg-light">
        ...
        <form class="row g-3 needs-validation" id="frmNuevoCliente" novalidate>
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="nit" name="nit" minlength="10" maxlength="11" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="razonSocial" name="razonSocial" minlength="1" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32) || (event.charCode == 209) || (event.charCode == 241))" required>
            <div class="invalid-feedback">
              Valida tu información
            </div>
          </div>
